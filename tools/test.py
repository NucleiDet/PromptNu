...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/hovernet/hovernet_adam-lr1e-4_bs8_256x256_300e_consep.py', help='train config file path')
    parser.add_argument('--checkpoint', default='work_dirs/hovernet/hovernet_adam-lr1e-4_bs8_256x256_300e_consep/debug/epoch_300.pth', help='checkpoint file')
...
def main():
    ...
    for data_test in data_test_list:
        ...
        data_loader = build_dataloader(
            dataset, samples_per_gpu=1, workers_per_gpu=cfg.data.workers_per_gpu, dist=distributed, shuffle=False, gpu_ids=cfg.gpu_ids)
