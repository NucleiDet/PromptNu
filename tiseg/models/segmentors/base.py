    ...
    def train_step(self, data_batch, optimizer, **kwargs):
        ...
        Returns:
            dict: It should contain at least 3 keys: ``loss``, ``log_vars``,
                ...
                averaging the logs.
        """
        losses = self(**data_batch) # data_batch['data']['img'].shape,data_batch['label']['sem_gt'].shape, data_batch['label']['point_gt'].shape=torch.Size([16, 3, 256, 256]) torch.Size([16, 1, 256, 256]) torch.Size([16, 1, 256, 256])
